...
if (grepl("2024", error_file_name)) {
  do_sensor_df <- read_excel(file.path(DO_SENSOR_DATA_DIR, "MHK_2024_DOSensor.xlsx"))
} else if (grepl("2025", error_file_name)) {
  do_sensor_df <- read_excel(file.path(DO_SENSOR_DATA_DIR, "MHK_2025_DOSensor.xlsx"))
}
```
