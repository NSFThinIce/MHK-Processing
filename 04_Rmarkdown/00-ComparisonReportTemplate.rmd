...
error_file_name <- paste0("Name of file here", ".csv") ##### <- EDIT
...
if (current_direcory == "04_Rmarkdown") {
  ...
  write_csv(error_df, error_file_name)
  write_csv(error_df_raw, "Sonde.csv")
  ...
  if (dir.exists(path_to_rmarkdown_dir)) {
    ...
    write_csv(error_df, file.path(path_to_rmarkdown_dir, error_file_name))
    write_csv(error_df_raw, file.path(path_to_rmarkdown_dir, "Sonde.csv"))
