...
<!-- The raw data -->
# The Dataframe with Errors
```{r}
error_df
```

# The Dataframe from the DO Sensor
```{r}
do_sensor_df
```
...
<!-- Lastly, save the modified error_df -->
...
if (current_direcory == "04_Rmarkdown") {
  write.csv(error_df, error_file_name)
  ...
  if (dir.exists(path_to_rmarkdown_dir)) {
    write.csv(error_df, file.path(path_to_rmarkdown_dir, error_file_name))
  } else {
    stop(
      paste0(
        "The directory '",
